...
target <- c(NA, "a", "TRUE", "1", "1.000000", "10000000000", "10000000000000000000")
expect_identical(
  RcppSimdJson:::.deserialize_json(test),
  target
)
...
target <- matrix(
  c(
    NA, "a", "TRUE", "1", "1.000000", "10000000000", "10000000000000000000",
    "10000000000000000000", "10000000000", "1.000000", "1", "TRUE", "a", NA
  ),
