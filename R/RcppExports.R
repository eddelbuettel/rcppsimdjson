...
.deserialize_json <- function(json, json_pointer = "", simplify_to = 0L, type_policy = 0L, int64_r_type = 0L) {
    .Call(`_RcppSimdJson_deserialize_json`, json, json_pointer, simplify_to, type_policy, int64_r_type)
}
